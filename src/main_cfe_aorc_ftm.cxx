...
***************************************************************/
void pass_icecontent_from_ftm_to_cfe(Bmi *cfe_bmi_model, BmiFreezeThaw ftm_bmi_model){
    ...
    ********************************************************************/
    ...
    ftm_bmi_model.GetValue("soil__mcliq", &(var[0]));
    std::cout<<"soil mc liq= "<< var[0]<<" "<<var[7]<<"\n";
 ...
 main(int argc, const char *argv[])
{
  ...
  ************************************************************************/
  ...
  for (int i = 0; i < 720; i++){
    ...
    pass_icecontent_from_ftm_to_cfe(cfe_bmi_model, ftm_bmi_model);
