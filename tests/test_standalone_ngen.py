...
golden_file="extern/SoilFreezeThaw/SoilFreezeThaw/tests/file_golden.csv"
...
for i in range(total_num_hours):
    errorerr_frozen_frac_mm = err_frozen_frac_mm + dat_ngen_icef["ice_fraction_schaake"][i] - dat_standalone_icef["ice_fraction"][i]
